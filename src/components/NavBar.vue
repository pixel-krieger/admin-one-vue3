  ...
  <nav v-show="isNavBarVisible" id="navbar-main" class="navbar is-fixed-top">
    ...
    <div class="navbar-menu fadeIn animated faster" :class="{ 'is-active': isMenuActive }">
      <div class="navbar-end">
        ...
        <a href="https://github.com/vikdiesel/admin-one-vue-bulma-dashboard"
          class="navbar-item has-divider is-desktop-icon-only" title="GitHub">
...
export default defineComponent({
  ...
  computed: {
    ...
    isAsideMobileExpanded() {
      return useMainStore().isAsideMobileExpanded;
    },
    isNavBarVisible() {
      return useMainStore().isNavBarVisible;
    },
    userName() {
      return useMainStore().userName;
    },
  },
  mounted() {
  ...
  methods: {
    ...
    asideDesktopOnlyToggle() {
      useMainStore().asideDesktopOnlyToggle();
    },
    menuToggle() {
