...
router.afterEach(to => {
  ...
  store.asideMobileStateToggle(false);
  store.asideDesktopOnlyToggle(false);

  document.title = to.meta && to.meta.title ? `${to.meta.title} — ${defaultDocumentTitle}` : defaultDocumentTitle;
});
